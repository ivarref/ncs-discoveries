...
def get_field_reserve():
    ...
    reserves = keep_fields(reserves, [u'fldName', u'fldRecoverableOil', u'fldNpdidField'])
...
def get_discovery_resource():
    ...
    resources = keep_fields(resources, [u'dscName', u'dscRecoverableOil', u'dscNpdidDiscovery'])
...
field_reserve = field_reserve.rename(columns = { u'fldName_x': 'name', u'fldRecoverableOil' : 'recoverableOil' })
field_reserve = keep_fields(field_reserve, [
#u'dscName',
    u'nmaName',
    u'name',
    u'dscDiscoveryYear',
...
discovery_resource = discovery_resource.rename(columns = { u'dscName' : 'name', u'dscRecoverableOil' : 'recoverableOil'})
discovery_resource = keep_fields(discovery_resource, [u'name', u'nmaName', u'dscDiscoveryYear', u'recoverableOil'])
